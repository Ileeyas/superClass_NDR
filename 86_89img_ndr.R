...
Landsat<-stack("C:/Users/Ileeya/Documents/ArcGIS/2015/Mask86_89.tif")
...
SC <- superClass(Landsat, trainData = train_shp, responseCol = "Land_cover", model = "rf", tuneLength = 1, trainPartition = 0.5, mode = "classification", predict = "TRUE", filename = "C:/Users/16064961/NDR_LDT/2015/out2015_8_4.tif", overwrite = TRUE)
